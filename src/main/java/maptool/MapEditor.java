...
public class MapEditor extends JFrame {
    ...
    private String currentMapFile = "src/main/resources/maps/map.txt";
    private String tilesFolder = "src/main/resources/tiles/";
    private String mapsFolder = "src/main/resources/maps/";
