...
public class Entity {
    ...
    public void dropItem(Entity droppedItem) {
        for (int i = 0; i < gp.obj[1].length; i++) {
            if (gp.obj[gp.currentMap][i] == null) {
                ...
                gp.obj[gp.currentMap][i].worldX = worldX; // the dead monster's position
    ...
    public void getRandomDirection(int interval) {
        ...
        if (actionLockCounter > interval) {// move every interval seconds
    ...
    public void damagePlayer(int attack) {
        if (gp.player.invincible == false) {
            ...
            // 对玩家造成了伤害，则有对应的击退效果（由怪物的knockBackPower决定）
            if (damage != 0) {
    ...
    public void draw(Graphics2D g2) {
        ...
        if (worldX + gp.tileSize * 5 > gp.player.worldX - gp.player.screenX &&
            ...
            if (type == 2 && hpBarOn == true) {
                ...
                double hyBarValue = oneScale * life;

                g2.setColor(new Color(35, 35, 35));
                g2.fillRect(screenX - 1, screenY - 16, gp.tileSize + 2, 12);

                g2.setColor(new Color(255, 0, 30));
                g2.fillRect(screenX, screenY - 15, (int) hyBarValue, 10);
    ...
    public void searchPath(int goalCol, int goalRow) {
        ...
        if (gp.pFinder.search() == true) {
            ...
            // if reaches goal, stop searching
    ...
    public int getDecected(Entity user, Entity[][] target, String targetName) {
        int index = 999;
